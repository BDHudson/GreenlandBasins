...
glacierName = "Heimdal"#"NW"#"ThuleArea" #"KangerD" 
...
surface_numpy = arcpy.RasterToNumPyArray(surface_tiff)
bed_numpy = arcpy.RasterToNumPyArray(bed_tiff)
errbed_numpy = arcpy.RasterToNumPyArray(errbed_tiff)
...
fileProcessingFolder = "Y:\\Documents\\DATA\\MORLIGHEM_NSIDC\\Heimdal\\"
